	        ...
	        do {
	            ...
	            switch(opcao) {
	                case 1:
	                    ...
	                    double preco = Double.parseDouble(JOptionPane.showInputDialog(null, "Informe o pre�o do produto:", "Pre�o", JOptionPane.QUESTION_MESSAGE));
	                    ...
	                    String descricao = JOptionPane.showInputDialog(null, "Informe a descri��o do produto:", "Descri��o", JOptionPane.QUESTION_MESSAGE);
	                    ...
	                    System.out.println(p.getId());
	                {
	                    try {
	                        ...
	                        JOptionPane.showMessageDialog(null, "Produto j� cadastrado", "Erro", JOptionPane.ERROR_MESSAGE);
	                    }
	                }
	                    break;
	                ...
	                case 2:
	                    ...
	                    if (prod1 != null) {
	                        JOptionPane.showMessageDialog(null, prod1, "Informa��es", JOptionPane.INFORMATION_MESSAGE);
	                    } else {
	                        JOptionPane.showMessageDialog(null, "Produto n�o encontrado", "Erro", JOptionPane.ERROR_MESSAGE);
	                    }                    
	                    break;
	                case 3:
	                    int codigo = Integer.parseInt(JOptionPane.showInputDialog(null, "Informe o c�digo do produto:", "C�digo", JOptionPane.QUESTION_MESSAGE));
	                    Produto prod2 = lv.pesquisar(codigo);
	                    if (prod2 != null) {
	                        JOptionPane.showMessageDialog(null, prod2, "Informa��es", JOptionPane.INFORMATION_MESSAGE);
	                    } else {
	                        JOptionPane.showMessageDialog(null, "Produto n�o encontrado", "Erro", JOptionPane.ERROR_MESSAGE);
	                    }   
	                    break;
